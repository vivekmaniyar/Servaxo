...
@NamedQueries({
    ...
    @NamedQuery(name = "TblOrderdetail.findByPartId", query = "SELECT t FROM TblOrderdetail t WHERE t.tblOrderdetailPK.partId = :partId"),
...
public class TblOrderdetail implements Serializable {
    ...
    public TblOrderdetail(int orderId, int partId) {
        this.tblOrderdetailPK = new TblOrderdetailPK(orderId, partId);
    }
    ...
    public TblParts getTblParts() {
        return tblParts;
    }

    public void setTblParts(TblParts tblParts) {
        this.tblParts = tblParts;
    }
    ...
    public String toString() {
        return "entities.TblOrderdetail[ tblOrderdetailPK=" + tblOrderdetailPK + " ]";
    }
